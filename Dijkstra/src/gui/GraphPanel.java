            ...
            if(e.isControlDown() && e.isShiftDown()){
                ...
                if(SwingUtilities.isLeftMouseButton(e)){
                    if(!graph.isDestination(selected))
                        ...
                        JOptionPane.showMessageDialog(null, "Nuk mund te vendoset nyja e destinacionit si nyje burimore");
                } else if(SwingUtilities.isRightMouseButton(e)) {
                    if(!graph.isSource(selected))
                        graph.setDestination(selected);
                    else
                        JOptionPane.showMessageDialog(null, "Nuk mund te vendoset nyja burimore si nyje e destinacionit");
                }else
                    return;
